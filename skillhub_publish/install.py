#!/usr/bin/env python3
"""Mnemosyne Memory v5.1.0 Stable — local installer. No download needed."""
...
if os.path.abspath(target) != os.path.abspath(ENGINE):
    ...
    print(f"Mnemosyne v5.1.0 Stable copied to {target}")
    ...
    print("Mnemosyne v5.1.0 already in current directory. Ready to use.")
...
try:
    ...
    print("Self-test: Mnemosyne v5.1.0 OK - project/temporal/MCP/doctor ready")
    import shutil as _s
