#!/usr/bin/env python3
"""Mnemosyne OS v7.0.2 Stable — local installer. No download needed."""
...
if os.path.abspath(target) != os.path.abspath(ENGINE):
    ...
    print(f"Mnemosyne v7.0.2 Stable copied to {target}")
    ...
    print("Mnemosyne v7.0.2 already in current directory. Ready to use.")
...
try:
    ...
    print("Self-test: Mnemosyne v7.0.2 OK - project/temporal/MCP/doctor ready")
    import shutil as _s
